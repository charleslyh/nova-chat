> **说明（2026-09-01）**：本文是早期推导文，成文于「Session 级可回放消息服务」假设之下，
> 其中的会话资源、开屏快照、热层冷层、权威区/边缘区拓扑等前提已由
> [D20](./decisions.md#d20-交付边界收口存储与订阅分离) /
> [D21](./decisions.md#d21-可靠性分层三类存储的差异化投入) /
> [D22](./decisions.md#d22-协议封闭子集与严格拒绝) 整体收口。
>
> 保留本文是为了备查推导过程；**产品契约以上述 ADR 与 [`../design/01-responses-api.md`](../design/01-responses-api.md) 为准**。
